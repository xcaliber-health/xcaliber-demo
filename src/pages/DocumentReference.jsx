...
export default function DocumentReference() {
  ...
  return (
    <div className="h-full bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex flex-col overflow-hidden">
      ...
      {/* Controls: Dropdowns left, button right */}
      <div className="flex-shrink-0 px-6 pb-3">
        <div className="max-w-7xl mx-auto flex items-end justify-between gap-4">
          {/* Left side: Patient & Document ID */}
          <div className="flex gap-4">
            <div>
              <label className="block text-xs font-medium text-gray-600 mb-1">Patient ID</label>
              <select
  ...
  <Button
    ...
    onClick={() => {
      ...
      setTimeout(() => {
        ...
        setShowJson(true); // show JSON
      }, 1200); // fake 1.2 seconds delay
    }}
    disabled={!jsonData}
  >
    Extract Entities
          ...
          <Card className="flex-1 flex flex-col overflow-hidden p-6">
            {loading ? (
              ...
              <div className="flex flex-col h-full">
                {!selectedResourceType ? (
                  <div className="flex flex-col h-full">
                    {/* Back button to return to PDF */}
                    <div className="mb-2">
                      <Button onClick={() => setShowJson(false)} className="bg-gray-200 hover:bg-gray-300">
                        ← Back to PDF
                      </Button>
                    </div>
                  ...
                  <>
                    {/* Top action bar for individual resource */}
                    <div className="flex justify-between items-center bg-gray-50 border-b p-2 mb-2">
                      <div className="flex gap-2">
                        <button
                          onClick={handleCopy}
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 text-sm px-2 py-1 rounded bg-indigo-100 hover:bg-indigo-200"
                        >
                          ← Back
                        </button>
                      </div>
