...
// // src/pages/ClinicalProcessing.jsx
...
// // ✅ Reusable components similar to FindAppointment
...
// //     setLoading(true);
// //     try {
// //       const result = await uploadClinicalPdf(file);
...
//           }
//           try {
//             const statusResponse = await fetch(`/api/request/${requestId}`);
