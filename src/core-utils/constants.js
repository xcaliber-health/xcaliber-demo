...
const NEXT_PUBLIC_URL = "https://xchange-sandbox.xcaliberapis.com/api/v1";
...
export const SOURCE_CONFIG = {
  ELATION: {
    token: process.env.NEXT_PUBLIC_XSOURCEID,
    timezone: "America/Los_Angeles",
    departmentId: "",
  },
  ATHENA: {
    token: process.env.NEXT_PUBLIC_ATHENA_XSOURCEID,
    timezone: "America/New_York",
    departmentId: "150", // Default department ID
  },
  EPIC: {
    token: process.env.NEXT_PUBLIC_EPIC_XSOURCEID,
    timezone: "America/New_York",
    departmentId: "",
  },
  ECW: {
    token: process.env.NEXT_PUBLIC_ECW_XSOURCEID,
    timezone: "America/New_York",
    departmentId: "",
  },
};
