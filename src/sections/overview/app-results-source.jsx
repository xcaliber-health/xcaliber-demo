...
function AppResultsSourcesRecordChange({ title, subheader, sx, ...other }) {
  return (
    <Card
      component={Stack}
      {...other}
    ...
    >
      ...
      >
        ...
        <Typography variant="h3">2,183</Typography>
      </Box>
...
AppResultsSourcesRecordChange.propTypes = {
  title: PropTypes.string,
  subheader: PropTypes.string,
  sx: PropTypes.object,
};

export default AppResultsSourcesRecordChange;
