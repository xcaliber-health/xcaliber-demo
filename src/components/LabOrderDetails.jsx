...
const LabOrderDetails = ({
  ...
  // Handle sidebar toggling without affecting modal states
  const toggleSidebar = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#F8FAFC]">
      {/* ℹ️ Patient Info Floating Button */}
      ...
      <Sheet open={isSidebarOpen} onOpenChange={toggleSidebar}>
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <X className="w-5 h-5 text-gray-700 cursor-pointer" onClick={() => setIsSidebarOpen(false)} />
          </div>

          {/* Navigation Items */}
          <div className="w-full flex flex-col space-y-4">
            {/* ✅ Lab Order Button (Closes Sidebar & Opens Modal) */}
            <Card
              ...
              onClick={() => {
                ...
                setOpenLabOrderModal(true); // ✅ Open Modal
              }}
            >
            ...
            {/* ✅ Lab Results Button (Closes Sidebar & Opens Modal) */}
            <Card
              className="w-full h-14 flex items-center gap-4 rounded-lg cursor-pointer transition-all duration-300 hover:bg-gray-100 border-gray-200 px-4"
              onClick={() => {
                setIsSidebarOpen(false); // ✅ Close Sidebar
                setOpenLabResultsModal(true); // ✅ Open Modal
              }}
            >
      ...
      {/* ✅ Independent Lab Order Modal */}
      <Dialog open={openLabOrderModal} onOpenChange={setOpenLabOrderModal}>
        <DialogContent className="absolute left-1/2 transform -translate-x-1/2 w-full max-w-5xl h-[90vh] bg-white shadow-lg rounded-lg flex flex-col mt-[48px]">
      ...
      <div className="pt-4 p-4">
        <Tabs value={selectedTab} className="h-full w-full">
