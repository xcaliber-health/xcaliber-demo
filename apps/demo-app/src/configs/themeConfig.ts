...
const themeConfig: Config = {
  templateName: 'XCaliber',
  settingsCookieName: 'XCaliber-cockpit-settings',
  ...
  toastPosition: 'bottom-right' // 'top-right', 'top-center', 'top-left', 'bottom-right', 'bottom-center', 'bottom-left'
}
